...
kb.add_fact(("Elma", "orang tua dari", "Tari"))
kb.add_fact(("Elma", "orang tua dari", "Nurul"))
kb.add_fact(("Elma", "orang tua dari", "Yanto"))
kb.add_fact(("Aprilia", "orang tua dari", "Hamzah"))
...
kb.add_fact(("Iqbal", "orang tua dari", "wanda"))
...
kb.add_fact(("Desi", "saudara perempuan dari", "Aprilia"))
kb.add_fact(("Desi", "saudara perempuan dari", "Ardi"))
kb.add_fact(("Aprilia", "saudara perempuan dari", "Desi"))
kb.add_fact(("Aprilia", "saudara perempuan dari", "Wahyu"))
kb.add_fact(("Aprilia", "saudara perempuan dari", "Ardi"))
...
# Paman
kb.add_fact(("Elma", "paman dari", "Hamzah"))
kb.add_fact(("Elma", "paman dari", "Eka"))
kb.add_fact(("Elma", "paman dari", "Mira"))
kb.add_fact(("Elma", "paman dari", "Bastian"))
...
kb.add_fact(("Iqbal", "paman dari", "Aji"))
kb.add_fact(("Iqbal", "paman dari", "Gunawan"))
kb.add_fact(("Iqbal", "paman dari", "Anggun"))
kb.add_fact(("Iqbal", "paman dari", "Boy"))
# Bibi
...
kb.add_fact(("Aprilia", "bibi dari", "Tari"))
kb.add_fact(("Aprilia", "bibi dari", "Nurul"))
kb.add_fact(("Aprilia", "bibi dari", "Yanto"))
kb.add_fact(("Aprilia", "bibi dari", "Eka"))
kb.add_fact(("Aprilia", "bibi dari", "Mira"))
kb.add_fact(("Aprilia", "bibi dari", "Bastian"))
...
kb.add_fact(("Elma", "kakek dari", "Wanda"))
kb.add_fact(("Elma", "kakek dari", "Aji"))
kb.add_fact(("Elma", "kakek dari", "Gunawan"))
